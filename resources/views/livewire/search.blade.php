<div class="relative pointer-events-auto">
    <button type="button" wire:click="showSearch"
        class="w-96 flex items-center text-sm leading-6 text-gray-400 rounded-md ring-1 ring-gray-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-gray-300 dark:bg-gray-700 dark:highlight-white/5 dark:hover:bg-gray-900"><svg
    ...
    <x-jet-dialog-modal wire:model="showSearchModal">
        <x-slot name="title">Search Products</x-slot>
        <x-slot name="content">
        ...
        <x-slot name="footer">
            <x-jet-button wire:click="closeSearchModal" class="text-white bg-gray-600 hover:bg-gray-800">Cancel
            </x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
</div>